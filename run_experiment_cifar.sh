...
python eval_membership_inference.py -d CIFAR10 -mia logreg -f output/test_cifar10/datasets/forget_set.csv -m2 output/test_cifar10/m2/m2_state_dict.pt -m3 output/test_cifar10/m3/m3_state_dict.pt -o output/test_cifar10 -bs 128
